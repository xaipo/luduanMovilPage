    ...
    <body>
        <div id="pagina">
            <div id="zonaContenido">
                <div align="center">
                    <div id="tituloForm" class="header">INSERTAR BODEGA</div>
                    <div id="frmBusqueda">
                            ...
                            <table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>                                
								...
								<tr>
                                    ...
                                    <td width="43%"><input NAME="Anombre" type="text" class="cajaGrande" id="nombre" size="250" maxlength="250"></td>
									 <td width="42%" rowspan="4" align="left" valign="top"><ul id="lista-errores"></ul></td>
								</tr>
								<tr>
                                    <td width="15%">Direcci&oacute;n</td>
                                    <td width="43%"><input NAME="Adireccion" type="text" class="cajaGrande" id="direccion" size="500" maxlength="500" ></td>									                                    
                                </tr>
