...
<!--                                                <tr>
                                        ...
                                        <td width="35%">                                                       
                                            <input NAME="codfactura" type="text" class="cajaPequena" id="codfactura" value="<?echo $maximo?>" readonly>
                                        </td>                                                    
                                    </tr>-->
                                <?php 
                                ...
                                <tr>
                                    ...
                                    <td width="25%"><input NAME="nombre" type="text" class="cajaGrande" id="nombre" size="45" maxlength="45" onClick="abreVentana()" readonly value="<?php echo utf8_decode(mysql_result($rs_cliente, 0, "nombre")); ?>">
                                    ...
                                    <td width="20%"><input NAME="codcliente" type="text" class="cajaPequena" id="codcliente" size="6" maxlength="5" value="<?php echo $idcliente ?>" readonly>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td >CI/RUC</td>
                                    <td  colspan="3"><input NAME="ci_ruc" type="text" class="cajaMedia" id="ci_ruc" size="20" maxlength="15" value="<?php echo mysql_result($rs_cliente, 0, "ci_ruc"); ?>" readonly></td>
...
<?php } ?>
                    ...
                    <input name="cbocredito" id="cbocredito" value="<?php echo $credito?>">
                                    ...
                                    <td style="width: 60%">
                                        <table class="fuente8">
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" class="cajaGrande" id="codigo_retencion" name="codigo_retencion" value="<?php echo $codigo_retencion?>" />
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" id="ret_iva" name="ret_iva" class="cajaPequena" value="<?php echo $ret_iva?>"/>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" id="ret_fuente" name="ret_fuente" class="cajaPequena" value="<?php echo $ret_fuente?>"/>
                                                </td>
                                            </tr>
                                    ...
                                    <td style="width: 50%">
                                        <table style="background: #ff9999">
                                            <tr>
                                                ...
                                                <td><textarea id="facturasCadena" name="facturasCadena"  cols="40" rows="3" readonly="true" ></textarea></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>                                           
...
?>
                    ...
                    <div id="frmBusqueda">
                        ...
                        <table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=1>
							...
							$bodega1 = mysql_result($rs_lineas, 0, "idbodega");
...
<?php } else { ?>
								...
								<td align="center"> 
									<?php  $queryb = "SELECT b.id_bodega as idbodega, b.nombre as nombre FROM bodega b INNER JOIN productobodega p ON b.id_bodega = p.id_bodega WHERE p.id_producto ='".$idproducto1."'";
										   $resb = mysql_query($queryb, $conn);?>
								
									<select name="cbobodega1" id="cbobodega1" class="comboPequeno" >
                                ...
                                <?php if ($idfactulinea1) { ?>
                                        ...
                                        <input NAME="descuento1" id="descuento1" type="text" class="cajaPequena2" size="10" maxlength="10" value="<?php echo $descuento_ind1 ?>" onchange="actualizar_porcentaje_descuento(1)">&#36;
<?php } else { ?>
                                        ...
                                        <input NAME="descuento1" id="descuento1" type="text" class="cajaPequena2" size="10" maxlength="10" value="0" onchange="actualizar_porcentaje_descuento(1)">&#36;
<?php } ?>
                                </td>
                                    <?php if ($idfactulinea1) { ?>
...
<?php if ($iva1 != 0) { ?>                                                                  
                                <input NAME="ivaporc1" id="ivaporc1" type="hidden" value="<?php echo $ivaporcetaje;?>"  onChange="suma_iva(1)">
                            <?php } else { ?>
...
if ($idfactulinea2) {
	...
	$bodega2 = mysql_result($rs_lineas, 1, "idbodega");
    ...
    <?php } ?>
                                    <td align="center"> 
									<?php  $queryb = "SELECT b.id_bodega as idbodega, b.nombre as nombre FROM bodega b INNER JOIN productobodega p ON b.id_bodega = p.id_bodega WHERE p.id_producto ='".$idproducto2."'";
										   $resb = mysql_query($queryb, $conn);?>
								
									<select name="cbobodega2" id="cbobodega2" class="comboPequeno" >
									
									<?php
                                            $contador=0;
                                            while ($contador < mysql_num_rows($resb))
                                            {
                                                if(mysql_result($resb,$contador,"idbodega")==$bodega2)
                                                {?>
													<option selected value="<?php echo mysql_result($resb,$contador,"idbodega")?>"><?php echo mysql_result($resb,$contador,"nombre");?></option>
                                    ...
                                    <td align="center">
                                        ...
                                        <input NAME="descuento2" id="descuento2" type="text" class="cajaPequena2" size="10" maxlength="10" value="<?php echo $descuento_ind2 ?>" onchange="actualizar_porcentaje_descuento(2)">&#36;
                                    </td>
    ...
    <?php if ($iva2 != 0) { ?>   
                                    <input NAME="ivaporc2" id="ivaporc2" type="hidden" value="<?php echo $ivaporcetaje;?>" onChange="suma_iva(2)">
    <?php } else { ?>
    ...
    ?> 
                                <tr class="itemParTabla">
                                    ...
                                    <td align="center">
                                        ...
                                        <input NAME="descuento2" id="descuento2" type="text" class="cajaPequena2" size="10" maxlength="10" value="0" onchange="actualizar_porcentaje_descuento(2)">&#36;
                                    </td>
...
if ($idfactulinea3) {
	...
	$bodega3 = mysql_result($rs_lineas, 2, "idbodega");
    ...
    ?>
                                ...
                                <?php } ?>
									...
									<td align="center"> 
									<?php  $queryb = "SELECT b.id_bodega as idbodega, b.nombre as nombre FROM bodega b INNER JOIN productobodega p ON b.id_bodega = p.id_bodega WHERE p.id_producto ='".$idproducto3."'";
										   $resb = mysql_query($queryb, $conn);?>
								
									<select name="cbobodega3" id="cbobodega3" class="comboPequeno" >
									
									<?php
                                            $contador=0;
                                            while ($contador < mysql_num_rows($resb))
                                            {
                                                if(mysql_result($resb,$contador,"idbodega")==$bodega3)
                                                {?>
													<option selected value="<?php echo mysql_result($resb,$contador,"idbodega")?>"><?php echo mysql_result($resb,$contador,"nombre");?></option>
                                    ...
                                    <td align="center">
                                        ...
                                        <input NAME="descuento3" id="descuento3" type="text" class="cajaPequena2" size="10" maxlength="10" value="<?php echo $descuento_ind3; ?>" onchange="actualizar_porcentaje_descuento(3)">&#36;
                                    </td>                                            
                                ...
                                <input name="costo3" id="costo3" value="<? echo $costo3;?>" type="hidden" >
    ...
    <?php if ($iva3 != 0) { ?>
                                    <input NAME="ivaporc3" id="ivaporc3" value="<?php echo $ivaporcetaje;?>" type="hidden" onChange="suma_iva(3)">
    <?php } else { ?>
    ...
    ?>
                                <tr class="itemImparTabla">
                                    ...
                                    <td align="center">
                                        ...
                                        <input NAME="descuento3" id="descuento3" type="text" class="cajaPequena2" size="10" maxlength="10" value="0" onchange="actualizar_porcentaje_descuento(3)">&#36;
                                    </td>                                            
    ...
    if ($idfactulinea4) {
		...
		$bodega4 = mysql_result($rs_lineas, 3, "idbodega");
        ...
        ?>
                                    ...
                                    <?php } ?>
										...
										<td align="center"> 
									<?php  $queryb = "SELECT b.id_bodega as idbodega, b.nombre as nombre FROM bodega b INNER JOIN productobodega p ON b.id_bodega = p.id_bodega WHERE p.id_producto ='".$idproducto4."'";
										   $resb = mysql_query($queryb, $conn);?>
								
									<select name="cbobodega4" id="cbobodega4" class="comboPequeno" >
									
									<?php
                                            $contador=0;
                                            while ($contador < mysql_num_rows($resb))
                                            {
                                                if(mysql_result($resb,$contador,"idbodega")==$bodega4)
                                                {?>
													<option selected value="<?php echo mysql_result($resb,$contador,"idbodega")?>"><?php echo mysql_result($resb,$contador,"nombre");?></option>
                                        ...
                                        <td align="center">
                                            ...
                                            <input NAME="descuento4" id="descuento4" type="text" class="cajaPequena2" size="10" maxlength="10" value="<?php echo $descuento_ind4; ?>" onchange="actualizar_porcentaje_descuento(4)">&#36;
                                        </td>
                                    ...
                                    <input name="idarticulo4" id="idarticulo4" value="<? echo $idproducto4; ?>" type="hidden" >
                                    ...
                                    <input name="costo4" id="costo4" value="<? echo $costo4;?>" type="hidden" >
                                    ...
                                    <input name="importe_con_iva4" id="importe_con_iva4" value="<?php echo $iva4; ?>" type="hidden">
                                            <?php if ($iva4 != 0) { ?>
                                        <input NAME="ivaporc4" id="ivaporc4" <?php echo $ivaporcetaje;?> type="hidden" onChange="suma_iva(4)">
        <?php } else { ?>
        ...
        ?>
                                    ...
                                    <tr class="itemParTabla">
                                        ...
                                        <td align="center">
                                            ...
                                            <input NAME="descuento4" id="descuento4" type="text" class="cajaPequena2" size="10" maxlength="10" value="0" onchange="actualizar_porcentaje_descuento(4)">&#36;
                                        </td>
        ...
        if ($idfactulinea5) {
			...
			$bodega5 = mysql_result($rs_lineas, 4, "idbodega");
            ...
            ?>
                                        ...
                                        <?php } ?>
											...
											<td align="center"> 
									<?php  $queryb = "SELECT b.id_bodega as idbodega, b.nombre as nombre FROM bodega b INNER JOIN productobodega p ON b.id_bodega = p.id_bodega WHERE p.id_producto ='".$idproducto5."'";
										   $resb = mysql_query($queryb, $conn);?>
								
									<select name="cbobodega5" id="cbobodega5" class="comboPequeno" >
									
									<?php
                                            $contador=0;
                                            while ($contador < mysql_num_rows($resb))
                                            {
                                                if(mysql_result($resb,$contador,"idbodega")==$bodega5)
                                                {?>
													<option selected value="<?php echo mysql_result($resb,$contador,"idbodega")?>"><?php echo mysql_result($resb,$contador,"nombre");?></option>
                                            ...
                                            <td align="center">
                                                ...
                                                <input NAME="descuento5" id="descuento5" type="text" class="cajaPequena2" size="10" maxlength="10" value="<?php echo $descuento_ind5; ?>" onchange="actualizar_porcentaje_descuento(5)">&#36;
                                            </td>
                                        ...
                                        <input name="idarticulo5" id="idarticulo5" value="<? echo $idproducto5; ?>" type="hidden" >                                       
                                        ...
                                        <input name="costo5" id="costo5" value="<? echo $costo5 ?>" type="hidden" >
            ...
            <?php if ($iva5 != 0) { ?>
                                            <input NAME="ivaporc5" id="ivaporc5" <?php echo $ivaporcetaje;?> type="hidden" onChange="suma_iva(5)">
                                                <?php } else { ?>
										...
										<select name="cbobodega5" id="cbobodega5" class="comboPequeno" ></select>																									
                                            ...
                                            <td align="center">
                                                ...
                                                <input NAME="descuento5" id="descuento5" type="text" class="cajaPequena2" size="10" maxlength="10" value="0" onchange="actualizar_porcentaje_descuento(5)">&#36;
                                            </td>
        ...
        if ($idfactulinea6) {
			...
			$bodega6 = mysql_result($rs_lineas, 5, "idbodega");
            ...
            ?>
                                        ...
                                        <?php } ?>
											...
											<td align="center"> 
									<?php  $queryb = "SELECT b.id_bodega as idbodega, b.nombre as nombre FROM bodega b INNER JOIN productobodega p ON b.id_bodega = p.id_bodega WHERE p.id_producto ='".$idproducto6."'";
										   $resb = mysql_query($queryb, $conn);?>
								
									<select name="cbobodega6" id="cbobodega6" class="comboPequeno" >
									
									<?php
                                            $contador=0;
                                            while ($contador < mysql_num_rows($resb))
                                            {
                                                if(mysql_result($resb,$contador,"idbodega")==$bodega6)
                                                {?>
													<option selected value="<?php echo mysql_result($resb,$contador,"idbodega")?>"><?php echo mysql_result($resb,$contador,"nombre");?></option>
                                            ...
                                            <td align="center">
                                                ...
                                                <input NAME="descuento6" id="descuento6" type="text" class="cajaPequena2" size="10" maxlength="10" value="<?php echo $descuento_ind6; ?>" onchange="actualizar_porcentaje_descuento(6)">&#36;
                                            </td>
                                        ...
                                        <input name="idarticulo6" id="idarticulo6" value="<? echo $idproducto6; ?>" type="hidden" >                                       
                                        ...
                                        <input name="costo6" id="costo6" value="<? echo $costo6 ?>" type="hidden" >
                                        ...
                                        <?php if ($iva6 != 0) { ?>
                                            <input NAME="ivaporc6" id="ivaporc6" type="hidden" <?php echo $ivaporcetaje;?> onChange="suma_iva(6)">
                                        <?php } else { ?>
            ...
            <?php } ?>
										...
										<select name="cbobodega6" id="cbobodega6" class="comboPequeno" ></select>																									
                                            ...
                                            <td align="center">
                                                ...
                                                <input NAME="descuento6" id="descuento6" type="text" class="cajaPequena2" size="10" maxlength="10" value="0" onchange="actualizar_porcentaje_descuento(6)">&#36;
                                            </td>
                                    ...
                                    if ($idfactulinea7) {
										...
										$bodega7 = mysql_result($rs_lineas, 6, "idbodega");
            ...
            <?php } else { ?>
                                        ...
                                        <?php } ?>
											...
											<td align="center"> 
									<?php  $queryb = "SELECT b.id_bodega as idbodega, b.nombre as nombre FROM bodega b INNER JOIN productobodega p ON b.id_bodega = p.id_bodega WHERE p.id_producto ='".$idproducto7."'";
										   $resb = mysql_query($queryb, $conn);?>
								
									<select name="cbobodega7" id="cbobodega7" class="comboPequeno" >
									
									<?php
                                            $contador=0;
                                            while ($contador < mysql_num_rows($resb))
                                            {
                                                if(mysql_result($resb,$contador,"idbodega")==$bodega7)
                                                {?>
													<option selected value="<?php echo mysql_result($resb,$contador,"idbodega")?>"><?php echo mysql_result($resb,$contador,"nombre");?></option>
                                            ...
                                            <td align="center">
                                                ...
                                                <input NAME="descuento7" id="descuento7" type="text" class="cajaPequena2" size="10" maxlength="10" value="<?php echo $descuento_ind7; ?>" onchange="actualizar_porcentaje_descuento(7)">&#36;
                                            </td>
                                        ...
                                        <input name="idarticulo7" id="idarticulo7" value="<? echo $idproducto7;?>" type="hidden" >                                        
                                        ...
                                        <input name="costo7" id="costo7" value="<? echo $costo7;?>" type="hidden" >
                                        ...
                                        <?php if ($iva7 != 0) { ?>
                                            <input NAME="ivaporc7" id="ivaporc7" type="hidden" <?php echo $ivaporcetaje;?> onChange="suma_iva(7)">
                                        <?php } else { ?>
										...
										<select name="cbobodega7" id="cbobodega7" class="comboPequeno" ></select>																									
                                            ...
                                            <td align="center">
                                                ...
                                                <input NAME="descuento7" id="descuento7" type="text" class="cajaPequena2" size="10" maxlength="10" value="0" onchange="actualizar_porcentaje_descuento(7)">&#36;
                                            </td>
        ...
        <?php } ?>                                        
                                    ...
                                    if ($idfactulinea8) {
										...
										$bodega8 = mysql_result($rs_lineas, 7, "idbodega");
            ...
            <?php } else { ?>
                                        ...
                                        <?php } ?>
											...
											<td align="center"> 
									<?php  $queryb = "SELECT b.id_bodega as idbodega, b.nombre as nombre FROM bodega b INNER JOIN productobodega p ON b.id_bodega = p.id_bodega WHERE p.id_producto ='".$idproducto8."'";
										   $resb = mysql_query($queryb, $conn);?>
								
									<select name="cbobodega8" id="cbobodega8" class="comboPequeno" >
									
									<?php
                                            $contador=0;
                                            while ($contador < mysql_num_rows($resb))
                                            {
                                                if(mysql_result($resb,$contador,"idbodega")==$bodega8)
                                                {?>
													<option selected value="<?php echo mysql_result($resb,$contador,"idbodega")?>"><?php echo mysql_result($resb,$contador,"nombre");?></option>
                                            ...
                                            <td align="center">
                                                ...
                                                <input NAME="descuento8" id="descuento8" type="text" class="cajaPequena2" value="<?php echo $descuento_ind8; ?>" size="10" maxlength="10" onchange="actualizar_porcentaje_descuento(8)">&#36;
                                            </td>
                                        ...
                                        <input name="idarticulo8" id="idarticulo8" value="<? echo $idproducto8;?>" type="hidden" >                                        
                                        ...
                                        <input name="costo8" id="costo8" value="<? echo $costo8;?>" type="hidden" >
                                        <input name="stock8" id="stock8" type="hidden" value="<? echo $stock8;?>">
                                        <input name="importe_con_iva8" id="importe_con_iva8" type="hidden" value="<? echo $iva8;?>">
                                        <?php if ($iva8 != 0) { ?>
                                            <input NAME="ivaporc8" id="ivaporc8" <?php echo $ivaporcetaje;?> type="hidden" onChange="suma_iva(8)">
                                        <?php } else { ?>
										...
										<select name="cbobodega8" id="cbobodega8" class="comboPequeno" ></select>																									
                                            ...
                                            <td align="center">
                                                ...
                                                <input NAME="descuento8" id="descuento8" type="text" class="cajaPequena2" size="10" maxlength="10" value="0" onchange="actualizar_porcentaje_descuento(8)">&#36;
                                            </td>
        ...
        if ($idfactulinea9) {
			...
			$bodega9 = mysql_result($rs_lineas, 8, "idbodega");
            ...
            <?php } ?>                                                    
											...
											<td align="center"> 
									<?php  $queryb = "SELECT b.id_bodega as idbodega, b.nombre as nombre FROM bodega b INNER JOIN productobodega p ON b.id_bodega = p.id_bodega WHERE p.id_producto ='".$idproducto9."'";
										   $resb = mysql_query($queryb, $conn);?>
								
									<select name="cbobodega9" id="cbobodega9" class="comboPequeno" >
									
									<?php
                                            $contador=0;
                                            while ($contador < mysql_num_rows($resb))
                                            {
                                                if(mysql_result($resb,$contador,"idbodega")==$bodega9)
                                                {?>
													<option selected value="<?php echo mysql_result($resb,$contador,"idbodega")?>"><?php echo mysql_result($resb,$contador,"nombre");?></option>
                                            ...
                                            <td align="center">
                                                ...
                                                <input NAME="descuento9" id="descuento9" type="text" class="cajaPequena2" value="<?php echo $descuento_ind9; ?>" size="10" maxlength="10" onchange="actualizar_porcentaje_descuento(9)">&#36;
                                            </td>
                                        ...
                                        <input name="idarticulo9" id="idarticulo9" value="<? echo $idproducto9;?>" type="hidden" >                                       
                                        ...
                                        <input name="costo9" id="costo9" value="<? echo $costo9;?>" type="hidden" >
                                        <input name="stock9" id="stock9" type="hidden" value="<? echo $stock9;?>">
                                        <input name="importe_con_iva9" id="importe_con_iva9" type="hidden" value="<? echo $iva9;?>">
                                        <?php if ($iva9 != 0) { ?>
                                            <input NAME="ivaporc9" id="ivaporc9" <?php echo $ivaporcetaje;?> type="hidden" onChange="suma_iva(9)">
                                        <?php } else { ?>
										...
										<select name="cbobodega9" id="cbobodega9" class="comboPequeno" ></select>																									
                                            ...
                                            <td align="center">
                                                ...
                                                <input NAME="descuento9" id="descuento9" type="text" class="cajaPequena2" size="10" maxlength="10" value="0" onchange="actualizar_porcentaje_descuento(9)">&#36;
                                            </td>
        ...
        if ($idfactulinea10) {
			...
			$bodega10 = mysql_result($rs_lineas, 10, "idbodega");
            ...
            <?php } ?>                                                    
											...
											<td align="center"> 
									<?php  $queryb = "SELECT b.id_bodega as idbodega, b.nombre as nombre FROM bodega b INNER JOIN productobodega p ON b.id_bodega = p.id_bodega WHERE p.id_producto ='".$idproducto10."'";
										   $resb = mysql_query($queryb, $conn);?>
								
									<select name="cbobodega10" id="cbobodega10" class="comboPequeno" >
									
									<?php
                                            $contador=0;
                                            while ($contador < mysql_num_rows($resb))
                                            {
                                                if(mysql_result($resb,$contador,"idbodega")==$bodega10)
                                                {?>
													<option selected value="<?php echo mysql_result($resb,$contador,"idbodega")?>"><?php echo mysql_result($resb,$contador,"nombre");?></option>
                                            ...
                                            <td align="center">
                                                ...
                                                <input NAME="descuento10" id="descuento10" type="text" class="cajaPequena2" value="<?php echo $descuento_ind10; ?>" size="10" maxlength="10"  onchange="actualizar_porcentaje_descuento(10)">&#36;
                                            </td>
                                        ...
                                        <input name="idarticulo10" id="idarticulo10" value="<? echo $idproducto10;?>" type="hidden" >                                        
                                        ...
                                        <input name="costo10" id="costo10" value="<? echo $costo10;?>" type="hidden" >
                                        <input name="stock10" id="stock10" type="hidden" value="<? echo $stock10;?>">
                                        <input name="importe_con_iva10" id="importe_con_iva10" type="hidden" value="<? echo $iva10;?>">
                                        <?php if ($iva10 != 0) { ?>
                                            <input NAME="ivaporc10" id="ivaporc10" <?php echo $ivaporcetaje;?> type="hidden" onChange="suma_iva(10)">
                                        <?php } else { ?>
										...
										<select name="cbobodega10" id="cbobodega10" class="comboPequeno" ></select>																									
                                            ...
                                            <td align="center">
                                                ...
                                                <input NAME="descuento10" id="descuento10" type="text" class="cajaPequena2" size="10" maxlength="10" value="0" onchange="actualizar_porcentaje_descuento(10)">&#36;
                                            </td>
        ...
        if ($idfactulinea11) {
			...
			$bodega11 = mysql_result($rs_lineas, 11, "idbodega");
            ...
            <?php } ?>                                                    
											...
											<td align="center"> 
									<?php  $queryb = "SELECT b.id_bodega as idbodega, b.nombre as nombre FROM bodega b INNER JOIN productobodega p ON b.id_bodega = p.id_bodega WHERE p.id_producto ='".$idproducto11."'";
										   $resb = mysql_query($queryb, $conn);?>
								
									<select name="cbobodega11" id="cbobodega11" class="comboPequeno" >
									
									<?php
                                            $contador=0;
                                            while ($contador < mysql_num_rows($resb))
                                            {
                                                if(mysql_result($resb,$contador,"idbodega")==$bodega11)
                                                {?>
													<option selected value="<?php echo mysql_result($resb,$contador,"idbodega")?>"><?php echo mysql_result($resb,$contador,"nombre");?></option>
                                            ...
                                            <td align="center">
                                                ...
                                                <input NAME="descuento11" id="descuento11" type="text" class="cajaPequena2" value="<?php echo $descuento_ind11; ?>" size="10" maxlength="10" onchange="actualizar_porcentaje_descuento(11)">&#36;
                                            </td>
                                        ...
                                        <input name="idarticulo11" id="idarticulo11" value="<? echo $idproducto11;?>" type="hidden" >                                        
                                        ...
                                        <input name="costo11" id="costo11" value="<? echo $costo11;?>" type="hidden" >
                                        <input name="stock11" id="stock11" type="hidden" value="<? echo $stock11;?>">
                                        <input name="importe_con_iva11" id="importe_con_iva11" type="hidden" value="<? echo $iva11;?>">
            <?php if ($iva11 != 0) { ?>
                                            <input NAME="ivaporc11" id="ivaporc11" <?php echo $ivaporcetaje;?> type="hidden" onChange="suma_iva(11)">
            <?php } else { ?>
										...
										<select name="cbobodega11" id="cbobodega11" class="comboPequeno" ></select>																									
                                            ...
                                            <td align="center">
                                                ...
                                                <input NAME="descuento11" id="descuento11" type="text" class="cajaPequena2" size="10" maxlength="10" value="0" onchange="actualizar_porcentaje_descuento(11)">&#36;
                                            </td>                                            
