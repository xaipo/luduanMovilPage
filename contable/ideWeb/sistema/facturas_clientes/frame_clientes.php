...
function pon_prefijo(pref,nombre,ci_ruc,tipo,cadena) {
	...
	parent.opener.document.formulario.ci_ruc.value=ci_ruc;
        ...
        var cad = cadena.replace("*", "\n", "gi")
        
        
        parent.opener.document.formulario.facturasCadena.value=cad;
        if(tipo=='CF')
        {
            parent.opener.document.formulario.tipo_cliente.value="CLIENTE FINAL";
            parent.opener.document.formulario.cboremision.value="0";
        }
        else
        {
            parent.opener.document.formulario.tipo_cliente.value="DISTRIBUIDOR";
            parent.opener.document.formulario.cboremision.value="1";
        }
