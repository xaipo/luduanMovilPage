                        ...
                        <form id="formulario" name="formulario" method="post" action="guardar_factura.php">
                            <table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
                                ...
                                <tr>
                                    ...
                                    <td width="25%"><input NAME="nombre" type="text" class="cajaGrande" id="nombre" size="45" maxlength="45" onClick="abreVentana()" readonly>
                                    ...
                                    <td width="20%"><input NAME="codcliente" type="text" class="cajaPequena" id="codcliente" size="6" maxlength="5" onClick="limpiarcaja()" readonly>
                                    </td>

                                    <td width="6%"><b>FACTURERO:</b></td>
                                    <td>
                                        <select id="facturero"  class="comboMedio" NAME="facturero" onchange="cambio_facturero()">                                            
                                            <?php
                                            $contador=0;
                                ...
                                <tr>
                                    ...
                                    <td >CI/RUC</td>
                                    <td  colspan="3"><input NAME="ci_ruc" type="text" class="cajaMedia" id="ci_ruc" size="20" maxlength="15" readonly></td>
                                ...
                                <tr>
                                    <td >Fecha</td>
                                    <td ><input NAME="fecha" type="text" class="cajaPequena" id="fecha" size="10" maxlength="10" value="<? echo $hoy?>" readonly> <img src="../img/calendario.png" name="Image1" id="Image1" width="16" height="16" border="0" id="Image1" onMouseOver="this.style.cursor = 'pointer'">
                                                ...
                                                <td style="width: 70%">
                                                    <table class="fuente8" style="width: 100%">
                                                        <tr>
                                                            ...
                                                            <td style="width: 70%">
                                                                <input type="text" class="cajaMediana" id="codigo_retencion" name="codigo_retencion" />
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" id="ret_iva" name="ret_iva" class="cajaPequena2" value="0" />
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" id="ret_fuente" name="ret_fuente" class="cajaPequena2" value="0"/>
                                                            </td>
                                                        </tr>
                                    ...
                                    <td style="width: 50%">
                                        <table style="background: #ff9999">
                                            <tr>
                                                ...
                                                <td><textarea id="facturasCadena" name="facturasCadena"  cols="40" rows="3" readonly="true" ><?php echo $debe ?></textarea></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
