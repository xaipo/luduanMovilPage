...
$fechahoy=date("Y-m-d");
$sel_fact="INSERT INTO facturasptmp_consig (codfactura,fecha) VALUE ('','$fechahoy')";
...
<html>
	<head>
		...
		function abreVentana(){
                    ...
                    {
                        alert ("Debe ingresar el No. y Autorizacion de la Consignacion");
                    }
                    else
                    {
	...
	<body>
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
				<div id="tituloForm" class="header">INSERTAR PRODUCTOS CONSIGNACION</div>
				<div id="frmBusqueda">
				<form id="formulario" name="formulario" method="post" action="guardar_factura.php">
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
                                                <tr>
                                                    <td width="6%">No. Documento</td>
						...
						<tr>
                                                    ...
                                                    <td ><input NAME="codproveedor" type="text" class="cajaPequena" id="codproveedor" size="6" maxlength="5" readonly></td>
                                            ...
                                            <div id="botonBusqueda">
                                              <div align="center">
                                                ...
                                                <!--<input id="codfamilia" name="codfamilia" value="<? echo $codfamilia?>" type="hidden">-->
                                                    ...
                                                    <input class="cajaTotales" name="iva0" type="hidden" id="iva0" size="12" value=0 align="right" readonly>
                                                    <input class="cajaTotales" name="iva12" type="hidden" id="iva12" size="12" align="right" value=0 readonly>
                                                    <input class="cajaTotales" name="flete" type="hidden" id="flete" size="12" value=0 align="right" onchange="sumar_flete()">
                                              </div>
                                            </div>
                                        </td>
                                    </tr>
