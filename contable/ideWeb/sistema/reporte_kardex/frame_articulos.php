...
function pon_prefijo(codarticulo,nombre,idarticulo,stock) {
	parent.opener.document.formulario.codarticulo.value=codarticulo;
	parent.opener.document.formulario.descripcion.value=nombre;
	parent.opener.document.formulario.idarticulo.value=idarticulo;
        parent.opener.document.formulario.stock.value=stock;
