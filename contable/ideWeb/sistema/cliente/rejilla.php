...
<html>
	<head>
		...
		function ver_cliente(idcliente) {
			parent.location.href="ver_cliente.php?idcliente=" + idcliente;
		}
		
		function modificar_cliente(idcliente) {
			parent.location.href="modificar_cliente.php?idcliente=" + idcliente;
		}
		
		function eliminar_cliente(idcliente) {
                    if (confirm("Atencion va a proceder a la baja de un cliente. Desea continuar?")) {
			parent.location.href="eliminar_cliente.php?idcliente=" + idcliente;
                    }
		}
