...
class Facturero
{
    ...
    public function save_facturero($conn, $serie1,$serie2,$autorizacion,$inicio,$fin,$fecha_caducidad)
    {

        $query="INSERT INTO facturero VALUES (null,'$serie1','$serie2','$autorizacion','$inicio','$fin','$fecha_caducidad')";
