		...
		function validar_cabecera()
			{
				...
				if (document.getElementById("fecha").value=="") mensaje+="  - Fecha\n";                                
                                ...
                                if(document.getElementById("cbocuenta").value=="0") mensaje+="  - Cuenta no seleccionado\n";
...
//						}
                ...
                function actualizar_totales()
                {
                    ...
                    var result7=Math.round(original7*10000)/10000 ;
	...
	<body>
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
				<div id="tituloForm" class="header">INSERTAR FACTURA GASTO</div>
				<div id="frmBusqueda">
				...
				<div id="tituloForm" class="header">PRODUCTOS</div>
				  ...
				  <tr>
                                      ...
                                      <td>
                                          ...
                                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Cantidad: <input NAME="cantidad" type="text" class="cajaMinima" id="cantidad" size="10" maxlength="10" value="1" onChange="actualizar_importe()">
                                      </td>					
					<td>
