<?php
	...
	$sQuery = "
		...
		FROM   producto WHERE (borrado = 0) AND (gasto=1)
                $sWhere
		$sOrder
		$sLimit
	";
	...
	while ( $aRow = mysql_fetch_array( $rResult ) )
	{
		$sOutput .= "[";
                 ...
                 $sOutput .= '"'.str_replace('"', '\"', "<a href='#' style='font-size: 11px; text-decoration: none' onClick='pon_prefijo(&#39;$codigo_aux&#39;,&#39;$nombre_aux&#39;,$id_aux,&#39;$iva_aux&#39;,&#39;$pvp_aux&#39;)'>".$aRow["stock"]."</a>").'",';
                ...
                $sOutput .= '"'.str_replace('"', '\"', "<a href='#'><img src='../img/seleccionar.gif' border='0' width='16' height='16' border='1' title='Modificar' onClick='pon_prefijo(&#39;$codigo_aux&#39;,&#39;$nombre_aux&#39;,$id_aux,&#39;$iva_aux&#39;,&#39;$pvp_aux&#39;)' onMouseOver='style.cursor=cursor'></a>").'",';
