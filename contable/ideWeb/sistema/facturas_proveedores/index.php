	...
	<body onLoad="inicio()">
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
				<div id="tituloForm" class="header">factura compra</div>
				<div id="frmBusqueda">
                                    <form id="form_busqueda" name="form_busqueda" method="post" action="rejilla.php" target="frame_rejilla">                                
                                        <br/>
                                        <img src="../img/botonnuevafactura.jpg" border="0" title ="nuevo facturacompra" border="1" onClick="nuevo_facturacompra()" onMouseOver="style.cursor=cursor">
                                </div>
                                     </form>
