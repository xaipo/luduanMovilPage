...
function modificar_linea(codfacturatmp, numlinea, importe, iva, descuento, utilidad, idbodega)
{
    
    miPopup = window.open("modificar_linea.php?codfacturatmp="+codfacturatmp+"&numlinea=" + numlinea+"&importe="+importe+"&iva="+iva+"&descuento="+descuento+"&utilidad="+utilidad+"&idbodega="+idbodega,"miwin","width=600,height=300,scrollbars=yes");
    miPopup.focus();
}
...
//if ($modif<>1) {
		...
		if ($retorno==0) {	
				...
				$sel_insert="INSERT INTO factulineaptmp (codfactura,numlinea,id_articulo,cantidad,costo,importe,dcto,iva,pvp,utilidad,id_bodega) VALUES ('$codfacturatmp','','$idarticulo','$cantidad','$precio','$importe','$descuento','$iva','$pvp','$utilidad','$bodega')";
...
$sel_lineas="SELECT b.codigo as codigo, b.nombre as nombre, a.numlinea as numlinea, a.cantidad as cantidad, a.costo as costo, 
					a.importe as importe, a.dcto as dcto, a.iva as iva, a.utilidad as utilidad, a.id_bodega as idbodega  
	...
	if ($i % 2) { $fondolinea="itemParTabla"; } else { $fondolinea="itemImparTabla"; } ?>
			<tr class="<?php  echo $fondolinea?>">
				...
				<td width="3%" ><a href="javascript:eliminar_linea(<?php  echo $codfacturatmp?>,<?php  echo $numlinea?>,<?php  echo $importe ?>,<?php  echo $iva?>,<?php  echo $descuento?>)"><img src="../img/eliminar.png" border="0"></a></td>
                                <td width="3%" ><a href="javascript:modificar_linea(<?php  echo $codfacturatmp?>,<?php  echo $numlinea?>,<?php  echo $importe ?>,<?php  echo $iva?>,<?php  echo $descuento?>, <?php echo $utilidad?>, <?php echo $idbodega?>)"><img src="../img/modificar.png" border="0"></a></td>
			</tr>
<?php  } ?>
</table>
