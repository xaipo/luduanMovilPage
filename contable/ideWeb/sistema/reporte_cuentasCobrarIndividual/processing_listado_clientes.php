...
//		}
		 ...
		 */
                ...
                $sOutput .= '"'.str_replace('"', '\"', "<a href='#' style='font-size: 11px; text-decoration: none' onClick='pon_prefijo($code_aux,&#39;$nombre_aux&#39;,&#39;$ciruc_aux&#39;,&#39;$tipo_aux&#39;)'>".$aRow["nombre"]."</a>").'",';
                $sOutput .= '"'.str_replace('"', '\"', "<a href='#' style='font-size: 11px; text-decoration: none' onClick='pon_prefijo($code_aux,&#39;$nombre_aux&#39;,&#39;$ciruc_aux&#39;,&#39;$tipo_aux&#39;)'>".$aRow["ci_ruc"]."</a>").'",';
                
                $sOutput .= '"'.str_replace('"', '\"', "<a href='#'><img src='../img/seleccionar.gif' border='0' width='16' height='16' border='1' title='Seleccionar' onClick='pon_prefijo($code_aux,&#39;$nombre_aux&#39;,&#39;$ciruc_aux&#39;,&#39;$tipo_aux&#39;)' onMouseOver='style.cursor=cursor'></a>").'",';
