...
$row = $proformero->get_proformero_id($conn, $idproformero);
	...
	<body>
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
                                    <div id="tituloForm" class="header">ACTUALIZAR DATOS PROFORMA</div>
				<div id="frmBusqueda">
				<form id="formulario" name="formulario" method="post" action="save_proformero.php">
				...
				<div id="botonBusqueda">
					...
					<input id="idproformero" name="idproformero" value="<?php echo $idproformero?>" type="hidden">
			  </div>
			  </form>
		  </div>
		  </div>
