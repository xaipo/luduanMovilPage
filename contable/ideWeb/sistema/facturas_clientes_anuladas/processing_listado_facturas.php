<?php
	...
	$aColumns = array('id_factura', 'codigo_factura', 'nombre',  'totalfactura', 'fecha' );
        $aColumnsAux=array('a.codigo_factura', 'b.nombre', 'a.totalfactura', 'a.fecha');
	 ...
	 */        
	$sQuery = "
		SELECT SQL_CALC_FOUND_ROWS a.id_factura as id_factura, a.codigo_factura as codigo_factura, b.nombre as nombre, a.totalfactura as totalfactura, a.fecha as fecha
		FROM   facturas a INNER JOIN cliente b ON a.id_cliente=b.id_cliente WHERE (a.anulado = 1)
                $sWhere
		$sOrder
		$sLimit
	";
