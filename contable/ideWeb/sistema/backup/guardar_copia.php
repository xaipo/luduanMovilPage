...
$usuarios = new ServidorBaseDatos();
$conn = $usuarios->getConexion();
...
$rs_maximo=mysql_query($sel_maximo,$conn);
...
$rs_sistema=mysql_query($sistema,$conn);
...
//datos del servidor para hacer los backups
$Servidor=$usuarios->getServer();
$Usuario=$usuarios->getUser();
$Password=$usuarios->getPassword();
$BaseDeDatos=$usuarios->getBaseDatos();
