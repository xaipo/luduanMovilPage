    ...
    <head>
        ...
        <script language="javascript">
            ...
            function abreVentana(){
                ...
                miPopup = window.open("ver_proveedores.php","miwin","width=900px,height=550px,scrollbars=yes");
                miPopup.focus();                
            }
    ...
    <body onLoad="inicio()">
        <div id="pagina">
            <div id="zonaContenido">
                <div align="center">
                    <div id="tituloForm" class="header">CUENTAS X PAGAR INDIVIDUAL</div>
                    <div id="frmBusqueda">
                        <form id="formulario" name="formulario" method="post" action="rejilla.php" target="frame_rejilla">
                            <table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>					
                                <tr>
                                    ...
                                    <td width="10%">C&oacute;digo Proveedor</td>
                                    <td width="25%"><input NAME="codproveedor" type="text" class="cajaPequena" id="codproveedor" size="6" maxlength="5"  readonly>
                                </tr>
                                <tr>
                                    <td>CI/RUC</td>
