...
<html>
	<head>
		...
		function ver_formapago(idformapago) {
			parent.location.href="ver_formapago.php?idformapago=" + idformapago;
		}
		
		function modificar_formapago(idformapago) {
                    
			parent.location.href="modificar_formapago.php?idformapago=" + idformapago;
		}
		
		function eliminar_formapago(idformapago) {
                    if (confirm("Atencion va a proceder a la baja de una forma de pago. Desea continuar?")) {
			parent.location.href="eliminar_formapago.php?idformapago=" + idformapago;
                    }
		}
        ...
        $(document).ready(function() {
                ...
                oTable = $('#example').dataTable( {
                        ...
                        "bProcessing": true,
                        "bServerSide": true,
                        "sAjaxSource": "processing_listado_formapagos.php",
                        ...
                        "oTableTools": {
                            ...
                            "aButtons": [
                                ...
                                /*{
                                        ...
                                        "sMessage": "<H3>Inventario formapagos</H3><br/>"
