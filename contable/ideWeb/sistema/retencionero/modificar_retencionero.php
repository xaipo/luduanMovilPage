...
$row = $retencionero->get_retencionero_id($conn, $idretencionero);
	...
	<body>
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
                                    <div id="tituloForm" class="header">ACTUALIZAR DATOS COMPROBANTE DE RETENCION</div>
				<div id="frmBusqueda">
				<form id="formulario" name="formulario" method="post" action="save_retencionero.php">
				...
				<div id="botonBusqueda">
					...
					<input id="idretencionero" name="idretencionero" value="<?php echo $idretencionero?>" type="hidden">
			  </div>
			  </form>
		  </div>
		  </div>
