...
function pon_prefijo(codigo,nombre,idarticulo,costo,pvp,iva)
{	
	parent.opener.document.formulario_lineas.codarticulo.value=codigo;
	parent.opener.document.formulario_lineas.descripcion.value=nombre;
        ...
        parent.opener.document.formulario_lineas.costo_articulo.value=costo;
        parent.opener.document.formulario_lineas.pvp_articulo.value=pvp;
        parent.opener.document.formulario_lineas.iva_articulo.value=iva;
