	...
	<body onLoad="inicio()">
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
				<div id="tituloForm" class="header">AGRUPACION</div>
				<div id="frmBusqueda">
                                    <form id="form_busqueda" name="form_busqueda" method="post" action="rejilla.php" target="frame_rejilla">                                
                                        <br/>
                                        <img src="../img/botonnuevoagrupacion.jpg" border="0" title ="nuevo Producto" border="1" onClick="nuevo_producto()" onMouseOver="style.cursor=cursor">
                                </div>
                                     </form>
